-- S-10 Phase 1: snapshot is_warmup in workout session RPCs
--
-- Exercise JSON shape for create/update:
-- [ { "exercise_id", "phase", "sort_order", "notes",
--     "sets": [{ "prescribed_reps", "prescribed_duration_seconds",
--                "prescribed_load_kg", "rest_after_seconds", "is_warmup" }] } ]
