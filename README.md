...
- [Design agent skills](docs/design-agent-skills.md) — when to use `frontend-design` vs. `impeccable`, where the skills are installed, and how skill output must respect trAInR conventions.
