...
- To file a new bug (GitHub issue + local triage report), use [github-issue-record](../github-issue-record/SKILL.md) (`/github-issue-record <description>`). Pass `#N` to sync an existing issue locally.
