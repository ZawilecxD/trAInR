...
- **Linear MCP**: Cursor agents can manage issues, projects, cycles, and docs via the Linear plugin (`plugins.linear` in `.cursor/settings.json`). OAuth through the plugin — no repo token. Skill: `.cursor/skills/linear-mcp/SKILL.md`.
