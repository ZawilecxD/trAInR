...
- **Design agent skills**: `.agents/skills/frontend-design/SKILL.md` sets visual direction for new or redesigned UI; `.agents/skills/impeccable/SKILL.md` handles production UI craft, critique, audit, polish, and hardening. Routing guide: `docs/design-agent-skills.md`. Product/design context: `PRODUCT.md`, `DESIGN.md`.
