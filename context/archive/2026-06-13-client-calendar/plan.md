...
- [x] 4.1 Type checking passes: `npx astro check` — b25e807
- [x] 4.2 Linting passes: `npm run lint` — b25e807
- [x] 4.3 Unit tests pass: `npm run test` (week-grouping boundaries, if extracted) — b25e807
- [x] 4.4 Build passes: `npm run build` — b25e807

#### Manual

- [x] 4.5 Month→Week toggle shows selected week as vertical agenda with per-day sessions + "Rest day" rows — b25e807
- [x] 4.6 Prev/next-week navigation refetches and updates correctly (Monday-start label) — b25e807
- [x] 4.7 Week-card status colours match month dots — b25e807
- [x] 4.8 Week view readable/scrollable one-handed on phone width; toggling back preserves context — b25e807
