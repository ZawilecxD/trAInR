...
- [x] 5.1 `get_variables` returns identical token set across all `.pen` files — 803731e
- [x] 5.2 `snapshot_layout(problemsOnly: true)` returns no problems in any file — 803731e
- [x] 5.3 Full screenshot set exported (every screen, both breakpoints) — 803731e
- [x] 5.4 `npm run lint` passes — 803731e

#### Manual

- [x] 5.5 Full screenshot set reviewed end-to-end as one cohesive system — 803731e
- [x] 5.6 `DESIGN.md` reflects final component inventory — 803731e
