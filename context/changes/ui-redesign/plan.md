...
- [ ] 3.1 `trainer_authoring.pen` exists; all frames export cleanly
- [ ] 3.2 `snapshot_layout(problemsOnly: true)` returns no problems
- [ ] 3.3 `get_variables` matches Phase 1 token set

#### Manual

- [ ] 3.4 Plan hub, session builder (create + edit), actuals review reviewed at both breakpoints
- [ ] 3.5 Consistency with existing trainer desktop screens confirmed

### Phase 4: Public & Auth Surface

#### Automated

- [ ] 4.1 `public_auth.pen` exists; all frames export cleanly
- [ ] 4.2 `snapshot_layout(problemsOnly: true)` returns no problems
- [ ] 4.3 Auth frames reference DS Input/Button components

#### Manual

- [ ] 4.4 Landing, signin, signup (both variants), confirm-email reviewed
- [ ] 4.5 Invite-token signup variant clearly distinct from standard signup
