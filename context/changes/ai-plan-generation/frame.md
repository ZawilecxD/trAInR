...
which is a deliberate, statable tradeoff rather than a blocker. Endurance is
different: it is genuinely unstorable and needs a schema decision before it can
be scoped at all.
